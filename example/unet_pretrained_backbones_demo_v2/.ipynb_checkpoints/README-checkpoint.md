...
```
python infer_pytorch.py --checkpoint /hy-tmp/code4/best.pth --input /hy-tmp/code4/3 --output-dir /hy-tmp/code4/runs --sahi --sahi-crop-size 256 256 --sahi-model-size 512 512
**自定义重叠比例**
...
| `--sahi-slice-size H W` | 训练时 image_size | 每个切片的高度和宽度 |
